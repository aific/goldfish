 ...
 *  
 *  From: http://tips4java.wordpress.com/2008/11/10/table-column-adjuster/
 *  
 *  @author Rob Camick
 */
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener
{
	...
	private void updateTableColumn(int column, int width)
	{
		...
		// If the preferred width is set, make it the max (default preferred
		// width is 75)
		
		if (tableColumn.getPreferredWidth() >= 100)
		{
			width = Math.min(width, tableColumn.getPreferredWidth());	
		}
